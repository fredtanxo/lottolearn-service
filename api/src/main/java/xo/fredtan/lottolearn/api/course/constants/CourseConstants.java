...
public class CourseConstants {
    ...
    public static final String COURSE_MEMBERS_CACHE_PREFIX = "course_members:";
    ...
    public static final Duration COURSE_MEMBERS_CACHE_EXPIRATION = Duration.ofMinutes(30);
